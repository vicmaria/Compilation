...
| LMJ.EArrayCharGet (a, i) -> MJ.EArrayGet (translate_expression a, translate_expression i)
| LMJ.EArrayCharAlloc e -> MJ.EArrayAlloc (translate_expression e)
| LMJ.EArrayCharLength e -> MJ.EArrayLength (translate_expression e)
| LMJ.EThis -> MJ.EThis
...
| LMJ.IIf2 (c, i1) -> MJ.IIf2 (translate_expression c, translate_instruction i1)
...
| LMJ.TypFloat -> MJ.TypFloat
| LMJ.TypChar -> MJ.TypChar
| LMJ.TypBool -> MJ.TypBool
| LMJ.TypIntArray -> MJ.TypIntArray
| LMJ.TypCharArray -> MJ.TypCharArray
