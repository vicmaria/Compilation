...
and raw_expression =
  ...
  | EArrayCharGet of expression * expression (** [EArrayGet (e1, e2)] represents the expression [e1[e2]]. *)
  | EArrayCharAlloc of expression (** [EArrayAlloc e] represents the expression [new int[e]]. *)
  | EArrayCharLength of expression (** [EArrayLength e] represents the expression [e.length]. *)
...
and constant =
  ...
  | ConstChar of char (** Char constant *)
...
and instruction =
  ...
  | IIf2 of expression * instruction (** [IIf2 (e, i1)] represents the instruction [if (e) i1]. *)
